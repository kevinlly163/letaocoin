...
MOC_DIR = build
UI_DIR = build
macx:QMAKE_CFLAGS += -stdlib=libstdc++
# use: qmake "RELEASE=1"
contains(RELEASE, 1) {
...
contains(USE_UPNP, -) {
    ...
    win32:LIBS += -lminiupnpc -liphlpapi -lws2_32
}
...
macx:ICON = src/qt/res/icons/letaocoin.icns
macx:TARGET = "LeTaoCoin-Qt"
